...
public class WebServiceHandler {
    ...
    public HashMap<String, String> getWebServiceDataFromHeader(String webServiceURL, ArrayList<NameValuePair> parametersList, String headerKey) {
        ...
        try {
            ...
            Header[] headers=response.getHeaders(headerKey);
             result=convertHeadersToHashMap(headers);
            ...
            Log.i("JSONResponse: ", headers.toString());
